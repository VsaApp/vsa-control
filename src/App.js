...
import {setUserCountChartData, setTrackingChartData, setAppVersionsData} from './ChartData.js';
  ...
  render() {
    ...
    return (
        <tr className="userRow">
          ...
          <td className="userValue" id="deviceid"><a href={'https://api.vsa.2bad2c0.de/tags/' + this.props.id} rel="noopener noreferrer" target="_blank">{this.props.id}</a></td>
        </tr>
    );
  }
}
...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.socket = openSocket('http://192.168.178.39:8000');
  ...
  createBugsButton = () => {
    ...
    if (allBugs === undefined) return <Button onClick={() => this.socket.emit('loadBugsVersions')} variant="outlined" color="inherit">Load</Button>;
    return (
      <Button 
        onClick={() => {
              ...
              <p>
                ...
                >
                  <div className="bug-container">
                    <div className="bug-item">Count:</div><div className="value">{bug.count}</div>
                    <div className="bug-item">Users:</div><div className="value">[{bug.ids.map((id) => <a href={"api.vsa.2bad2c0.de/tags/" + id}>{id}, </a>)}]</div>
                    <div className="bug-item">Msg:</div><div className="value"><code>{!isExpanded ? bug.msg.split('\n')[0] : this.createFullBugMsg(bug.msg)}</code></div>
                  </div>
                </Button>
                <IconButton 
                  variant="outlined"
      ...
      <div className="App" >
        ...
        <body>
          <div className="grid-container">
            <div className="grid-item">Updated:           </div><div className="grid-item"><b className="Value">{this.state.timestamp}</b></div>
            <div className="grid-item"><a href="#devices">Current user count:</a></div><div className="grid-item"><b className="Value">{this.state.userCount}</b></div>
            <div className="grid-item"><a href="#appStarts">App users today:</a></div><div className="grid-item"><b className="Value">{this.state.userCountToday}</b></div>
            <div className="grid-item"><a href="#appStarts">App starts today:  </a></div><div className="grid-item"><b className="Value">{this.state.appStartsToday} ({this.state.userCountToday === 0 ? '0' : (this.state.appStartsToday / this.state.userCountToday)} / User)</b></div>
            <div className="grid-item"><a href="#tracking">Newest App Version:  </a></div><div className="grid-item"><b className="Value">{this.state.newestVersion[0]} ({this.state.newestVersion[1]} User)</b></div>
            <div className="grid-item"><a href="#tracking">Oldest App Version:  </a></div><div className="grid-item"><b className="Value">{this.state.oldestVersion[0]} ({this.state.oldestVersion[1]} User)</b></div>
          </div> 
          <h2>Stats</h2>
          <div id="tracking">
            <div className="category" id="appStarts">
              ...
              <div className="ChartInfo">
                <p>Overview</p>
                <div className="grid-container">
                  <div className="grid-item">App starts in {this.getChartData('trackingChartData').month}:</div><div className="grid-item"><b className="Value">{this.state.appStartsPerUser}</b></div>
                  <div className="grid-item">Users per day in {this.getChartData('trackingChartData').month}</div><div className="grid-item"><b className="Value">{this.state.userPerDay}</b></div>
                  <div className="grid-item">App users today:</div><div className="grid-item"><b className="Value">{this.state.userCountToday || '-'}</b></div>
                  <div className="grid-item">App starts today:</div><div className="grid-item"><b className="Value">{this.state.appStartsToday || '-'} ({this.state.userCountToday === 0 ? '-' : this.state.appStartsToday / this.state.userCountToday} / User)</b></div>
                </div> 
              </div>
            </div>
            ...
            <div className="category" id="userCount">
              ...
              <div className="ChartInfo">
                <p>Overview </p>
                <div className="grid-container">
                  <div className="grid-item">Current User Count:</div><div className="grid-item"><b className="Value">{this.state.userCount}</b></div>
                  <div className="grid-item">Zunahme:</div><div className="grid-item"><b className="Value">{this.state.countIncreaseAbsolut}</b></div>
                  <div className="grid-item">Zunahme in %:</div><div className="grid-item"><b className="Value">{this.state.countIncrease} %</b></div>
                </div> 
              </div>
            </div>
          </div>
          ...
          <div id="devices" className="category users">
            <p><b>Firebase users ({this.state.userCount})</b><Button onClick={() => this.setState({devices: undefined})} variant="outlined" className="cancelButton" color="inherit">X</Button></p>
            {this.createDevicesTable(true)}
          </div>
          <div className="category users">
            <p><b>Onesignal users ({this.state.oldUserCount})</b><Button onClick={() => this.setState({users: undefined})} variant="outlined" className="cancelButton" color="inherit">X</Button></p>
